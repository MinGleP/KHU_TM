...
int FileManager::loadImages(std::string imageFolder, std::vector<ImgInfo>& imgInfos)
{
...
int FileManager::readPassiveSensorInfo(const std::vector<std::string>& passiveInfoPath, std::vector<ImgInfo>& imgInfos)
{
